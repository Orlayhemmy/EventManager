      ...
      <div className="wc">
        ...
        {this.props.counter > 0 ? 
            <div className="page-icon bounce">
              <i className="fa fa-chevron-up icon" id="previous" onClick={this.props.nextEvents}></i>
            </div> : '' 
          }
        <div className="row">
          {content}
        ...
        {events.length > 8 ?
          <div className="page-icon bounce">
            <i className="fa fa-chevron-down icon" id="next" onClick={this.props.nextEvents}></i>
          </div> : ''
        }
      </div>
    )
